        ...
        <SectionComponent id="blogs" title="Blogs & Articles" background="dark">
            <div className="blog-content-wrapper">
                <BlogCard
                    ...
                    description={
                        'Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, magnam et molestiae consequatur illo explicabo exercitationem iusto nobis incidunt esse voluptatem, perferendis in laborum non harum dolor quia inventore cum?'
                    }
                />
                <BlogCard
                    user={'Govind Pawar'}
